...
buttonsInfo.set(buttonTypes.REMOVE_BUTTON, { buttonClass: 'delete-task-button', icon: '✖' });
buttonsInfo.set(buttonTypes.DELETE_BUTTON, { buttonClass: 'ready-task-button', icon: '✔' });
